            ...
            <div className="grid grid-cols-1 md:grid-cols-2 px-10 gap-10 gap-y-16 pb-24">
                {posts.map(post => (
                    ...
                    group-hover:scale-105 transition-transform duration-200 ease-out">
                            ...
                            backdrop-blure-lg rounded drop-shadow-lg text-white p-5
                            ...
                            <div className="mt-5 flex-1">
                                ...
                                <p className=" line-clamp-2 mb-5 mt-7">{post.description}</p>
                            </div>
                            <p className="mt-5 font-bold flex items-center group-hover:underline" >Read Post <ArrowRightIcon className="ml-2 h-4 w-4" /></p>
                        </div>
                    </ClientSideRoute>
                ))}
